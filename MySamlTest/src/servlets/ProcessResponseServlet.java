...
public class ProcessResponseServlet extends HttpServlet {
  ...
  private static final String domainName = "allianceglobalservices.com";
  ...
  private String createSamlResponse(String authenticatedUser, String notBefore,
      ...
      throws SamlException {
    String filepath = "C:\\Softwares\\eclipse\\workspace\\MySamlTest\\src\\templates\\" + samlResponseTemplateFile;
    ...
    if (SAMLRequest == null || SAMLRequest.equals("null")) {
      ...
      try {
        ...
        if (username == null) {
           ...
           */
          String publicKeyFilePath = "C:\\Softwares\\eclipse\\workspace\\MySamlTest\\WebContent\\keys\\DSAPublicKey01.key";
          String privateKeyFilePath = "C:\\Softwares\\eclipse\\workspace\\MySamlTest\\WebContent\\keys\\DSAPrivateKey01.key";
